...
User type:</label>
  <i class='fas fa-user-check'></i>
          <input type="radio" name="user_type" placeholder="Enter your type"value="user">
          <label>user</label>
           <input type="radio" name="user_type" placeholder="Enter your type"value="admin">
          <label>admin</label>
    ...
    <div class="button-area">
      <button type="submit" name="submit" value="register now"> Register <i class="fa fa-paper-plane"></i></button>
     </div>

    <div class="new">
      <p style="color: black; font-family:Nunito, sans-serif; margin-right: 200px; font-size: 12px;"><b>
        Already have an account? <a href="login_form.php">Login Now</a></b>
      </p>
    </div>
